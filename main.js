...
container.innerHTML = `<h1>People who must know of Miffles the Vampire Weiner Dog</h1>`

customers.forEach(customer => {
  // Add h1 name
  let name = document.createElement('h3')
  name.innerText = `${customer.first_name} ${customer.last_name}`
  container.appendChild(name)

  let ul = document.createElement('ul')
  container.appendChild(ul)

  let emailArr = customer.contacts.email
  emailArr.forEach(address => {
